    ...
    <main className="min-h-screen bg-paper px-5 py-6 sm:px-10 sm:py-10">
      <div className="mx-auto max-w-xl">
        ...
        <header className="mb-10 mt-16 sm:mt-20">
          ...
          <h1 className="mt-4 font-display text-5xl font-black uppercase leading-[0.9] tracking-[-0.04em] sm:text-7xl">{copy.auth.loginTitle}</h1>
        </header>
        <LoginForm />
        <p className="mt-8 text-sm text-ink/55">{copy.auth.newHere} <Link href="/signup" className="font-bold text-ink underline decoration-accent decoration-2 underline-offset-4">{copy.auth.createAccount}</Link></p>
      </div>
    </main>
  );
}
