...
export default async function SettingsPage() {
 ...
 <Link href="/account" className="inline-flex min-h-11 items-center gap-2 text-xs font-bold uppercase tracking-[0.18em] text-text-muted"><ArrowLeft size={16} /> {copy.navigation.myAccount}</Link>
 ...
 <h1 className="mt-4 font-display text-5xl uppercase leading-[0.9] tracking-[0.01em] sm:text-6xl">{copy.auth.settingsTitle}</h1>
 <p className="mt-5 text-lg leading-relaxed text-text-muted">{copy.auth.settingsDescription}</p>
 </header>
